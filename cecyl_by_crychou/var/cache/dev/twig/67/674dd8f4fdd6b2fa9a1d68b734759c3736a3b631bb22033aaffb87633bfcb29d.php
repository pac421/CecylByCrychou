...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/srv/http/CecylByCrychou/cecyl_by_crychou/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}

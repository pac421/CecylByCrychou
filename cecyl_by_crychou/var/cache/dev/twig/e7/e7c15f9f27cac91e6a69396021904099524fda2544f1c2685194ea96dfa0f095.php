...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/srv/http/CecylByCrychou/cecyl_by_crychou/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}

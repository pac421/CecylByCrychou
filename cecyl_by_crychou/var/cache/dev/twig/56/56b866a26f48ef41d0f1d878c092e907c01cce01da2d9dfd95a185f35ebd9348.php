...
class __TwigTemplate_5ec133609edf718979879902e35e5e1cf4a32b063da75b5277b42924956d770f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <table id=\"datatable-users\" class=\"table table-striped table-bordered\" style=\"width:100%\">
        <thead>
        <tr>
            <th>Prénom</th>
            <th>Nom</th>
...
";
    ...
    ";
        // line 30
        echo $this->extensions['Symfony\WebpackEncoreBundle\Twig\EntryFilesTwigExtension']->renderWebpackScriptTags("admin_users");
        echo "
";
...
{% block title %}Utilisateurs &#183; Crychou{% endblock %}
...
{% block javascripts %}
    {{ parent() }}
    {{ encore_entry_script_tags('admin_users') }}
{% endblock %}", "admin/users.html.twig", "/srv/http/CecylByCrychou/cecyl_by_crychou/templates/admin/users.html.twig");
    }
}

...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/validator.html.twig", "/srv/http/CecylByCrychou/cecyl_by_crychou/vendor/symfony/web-profiler-bundle/Resources/views/Collector/validator.html.twig");
    }
}
